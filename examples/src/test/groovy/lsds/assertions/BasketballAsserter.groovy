 ...
 */
class BasketballAsserter extends IncidentsAsserter implements Assertable {

    private static String msg = "The recorded Basketball incidents lists must be identical in size, order and content"
    private static Tuple2<Pattern, String>[] DEFAULT_BASKETBALL_RGX = [
     ...
     */
    BasketballAsserter(List<TopicUpdate>  expected, List<TopicUpdate>  actual) {
        super(msg, expected, actual)
        masksList = updateMasks(expected, updateMasks(actual, DEFAULT_BASKETBALL_RGX))
